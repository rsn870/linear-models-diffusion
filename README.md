...
2. **Constant Deceleration** We have $$u_{t} = u_{0} -\frac{0.001t}{K} +\frac{0.001t^{2}}{2K^{2}} + n$$ where $I$ is the identity matrix and $K$ is the time horizon. This represents a particle at position $u_{0}$ that will come to rest at $u_{0}-0.0005$ at time $K$ with an initial velocity of $\frac{-0.001}{K}$ and a constant accelaration of $\frac{0.001}{K^{2}}$ throughout.
...
4. **Constant velocity as varying brightness** Consider the equation $$u_{t} = u_{0} -\frac{0.7t}{K}u_{0} + n$$ This represents a case where particle reaches $0.3u_{0}$ at time $K$ with a constant velocity $-\frac{0.9}{K}u_{0}$. Practically this is equivalent to darkening the image! 
