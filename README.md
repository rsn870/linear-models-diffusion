...
5. **Velocity as varying brightness with constant deceleration** Consider the equation $$u_{t} = u_{0} -\frac{bt}{K}u_{0} + \frac{bt^{2}}{2K^{2}}u_{0} + n$$ This represents a case where particle comes to rest at $\frac{(1-b)}{2}u_{0}$ at time $K$ with an initial velocity $-\frac{b}{K}u_{0}$ and constany acceleration $\frac{a}{K^{2}}u_{0}$.
