...
4. **Constant velocity as varying brightness** Consider the equation $$u_{t} = u_{0} -\frac{0.9t}{K}u_{0} + n$$ This represents a case where particle reaches $0.1u_{0}$ at time $K$ with a constant velocity $-\frac{0.9}{K}u_{0}$. Practically this is equivalent to darkening the image! 
